...
const LOCATIONS = [...new Set(SOURCE_ITEMS.map(i=>i.location))].sort();
...
const s={
  ...
  cIn:{width:72,textAlign:"center",padding:"7px 4px",borderRadius:8,border:"2px solid #d1d5db",fontSize:22,fontWeight:700,transition:"all 0.2s"},
